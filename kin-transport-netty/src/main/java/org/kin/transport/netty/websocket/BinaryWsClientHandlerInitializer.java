 ...
 * @date 2020/8/21
 */
public class BinaryWsClientHandlerInitializer extends AbstractChannelHandlerInitializer {
    private final WSClientHandler wsClientHandler;

    public BinaryWsClientHandlerInitializer(TransportOption transportOption, WSClientHandler wsClientHandler) {
